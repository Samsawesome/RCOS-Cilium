...
def send_message():
    ...
    if message:
        if sender_id == 'app2':
            print("App 2 sent message at", timestamp) # log message with timestamp in console for error checking
            ...
            requests.post("http://app3:5002/send_message", json={"timestamp": timestamp, "message": message, "sender_id": "app2"})
            return (jsonify({"status": "Message sent successfully"}), 200)
        elif sender_id == 'app1':
            print("App 1 sent message at", timestamp) # log message with timestamp in console for error checking
